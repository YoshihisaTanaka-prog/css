...
class ValuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create value" do
    assert_difference("Value.count") do
      post values_url, params: { value: { original_tag_id: @value.original_tag_id, title_id: @value.title_id, value: @value.value } }
    end
  ...
  test "should update value" do
    patch value_url(@value), params: { value: { original_tag_id: @value.original_tag_id, title_id: @value.title_id, value: @value.value } }
